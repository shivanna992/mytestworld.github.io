    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <%--<asp:UpdatePanel runat="server" ID="pnl1">
                <ContentTemplate>--%>
                    <asp:Button runat="server" ID="btnClick" Text="SUBMIT" Font-Bold="true" CssClass="btn btn-group-lg btn-warning" Font-Italic="true" OnClick="btnClick_Click" style="margin-left:-600px;margin-top:-1200px"/>
               <%-- </ContentTemplate>
            </asp:UpdatePanel>--%>
